...
<body>
    ...
    <div class= "registrationblock">
        ...
        <a href = "user.php"><img class = "cancel" src="nav/cross.svg" alt="cancel"></img></a>
            <img class = "logo" src="images/logo.png" alt="logo"></img><br><br>

            <p>Please fill in the details <br> 
            of the sport you would like to take part in</p><br>
...
?>
            ...
            <div class ="inputs">
            <form action="includes/sportReg.inc.php" method="post">
                <select name ="sport">
                    ...
                    <button type="submit" name="sportRegister">REGISTER</button><br><br>
        </form>
        </div>
