...
?><button></form>
        ...
        <div class= "game_class">
            <h1 class="h1_title">Games</h1>

        <div class = "search">
            <form action="search.php" method="post">
            <input class = "search_input" type="text" name="search" placeholder="Search">
            <button class = "search_btn" type="submit" name="submit-search">Search</button>
            </form>
        </div>
...
<?php
         ...
         echo " <form method='post' action='".setGames($conn)."'>
         
          <select class = 'game_select' id='sport' name='sport'>
            <option value='Swimming'>Swimming</option>
            <option value='Football'>Football</option>
            <option value='Tennis'>Tennis</option>
          </select><br>
          <input class = 'game_input' type='date' name='gameday'><br>
          <select class = 'game_select' id='location' name='location'>
          ...
          <button class = 'game_button' type='submit' name='gameSubmit'>Submit</button>
          </form>
